    ...
    return (
        <NavContainer>
            <Nav>
                ...
                <List isOpen={isOpen}>
                    <Item isOpen={isOpen} style={{ transitionDuration: isOpen && "0.5s"}}>
                        <NavLink to="/About">회사소개</NavLink>
                    </Item>
                    <Item isOpen={isOpen} style={{transitionDuration: isOpen && "0.6s"}}>
                        <NavLink to="/Projects">요금안내</NavLink>
                    </Item>
                    <Item isOpen={isOpen} style={{transitionDuration: isOpen && "0.7s"}}>
